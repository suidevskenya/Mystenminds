...
function ChatContent({ account, messages, input, setInput, handleSend, robotState, messagesEndRef }: ChatContentProps) {
  ...
  return (
    <div className="min-h-screen bg-[#2a1a8a] text-white flex">
      {/* Always show sidebar, just change its width */}
      <div className="fixed top-0 left-0 bottom-0 z-40">
        <Sidebar />
      </div>

      {/* Adjust margin based on sidebar state: ml-64 when expanded, ml-16 when collapsed */}
